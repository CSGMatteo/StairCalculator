...
export default function HardwoodRoom({ quote, setQuote, setMode, setPage }) {
    ...
    const [step, setStep] = useState("hardwoodMethod");
    ...
    const [glueAssist, setglueAssist] = useState(false)
    
    const [selectedFloor, setSelectedFloor] = useState("hardwood")
    // Room Logic
    ...
    return (
        <>
            <button
                ...
                className="fixed w-40 h-14 top-4 right-4 bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow-lg font-semibold transition"
            >
                Flooring Selection
            </button>
            ...
            {step === "hardwoodMethod" && (
                <div className="bg-white rounded-2xl shadow-xl p-10 text-center space-y-6">
                    <h1 className="text-3xl font-bold text-center">
                        Is glue required? (Glue Assist or Full Nailed)
                    </h1>
